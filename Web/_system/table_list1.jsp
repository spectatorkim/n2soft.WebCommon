...
function Go(table) {
    parent.mainFrame.location.href = "table_info.jsp?table=" + table;
}

function fnPop(table) {
    window.open("table_info.jsp?table=" + table, table, "width=700,height=800,resizable=yes,scrollbars=yes");
}
...
<table width="100%" cellpadding="2" cellspacing="0" border="0" style="margin-bottom:6px;">
    <tr>
        ...
        <form name="frmSch" method="post" action="table_list.jsp">
            <td class="title" align="right" style="white-space:nowrap;">
                <input type="button" value="ALL" onclick="fnSearch('')"><input type="button" value="LN" onclick="fnSearch('LN')"><input type="button" value="AC" onclick="fnSearch('AC')"><input type="button" value="CM" onclick="fnSearch('CM')">
