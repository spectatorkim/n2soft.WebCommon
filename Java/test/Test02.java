...
public class Test02 {
	...
	public static void main(String[] args) {
		StringMap data = getCompanyInfo("1058679335");

		System.out.println(data.toString(true));
	}

	public static StringMap getCompanyInfo(String tax_id) {
...
//		System.out.println(src);
		...
		data.put("co_addr", co_addr1 + " " + co_addr2);
	...
	public static StringMap getCompanyInfo2(String ked_cd) {
		StringMap data = new StringMap();
		String src = new String();
